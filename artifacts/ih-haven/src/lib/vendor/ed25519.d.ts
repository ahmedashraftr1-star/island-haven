// VENDORED from @noble/ed25519@3.1.0 (MIT, © Paul Miller paulmillr.com).
// Copied verbatim — do not edit. Used browser-side to VERIFY Island Haven
// attestation signatures with zero trust in the server. Vendored (not a
// dependency) to keep the pnpm lockfile untouched. Upstream: https://github.com/paulmillr/noble-ed25519
/** Alias to Uint8Array. */
