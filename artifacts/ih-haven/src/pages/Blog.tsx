              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center gap-5 p-[clamp(1.5rem,4vw,3rem)]">
                  ...
                  <span className="mt-1 inline-flex items-center gap-2 t-caption font-semibold uppercase tracking-[0.16em] rtl:tracking-normal text-primary">
                    ...
                    <ArrowLeft className="w-3.5 h-3.5 ltr:rotate-180 transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none rtl:group-hover:-translate-x-1 ltr:group-hover:translate-x-1 rtl:group-hover:translate-x-1" />
                  </span>
                </div>
              </div>
            </Link>
