...
const FALLBACK = {
  ...
  titleA: "مساحة",
  titleAccent: "نجاة",
  titleB: "مهنيّة، قبل أن تكون مكاناً للعمل.",
  body: "مبادرة من «من الناس إلى الناس»، نوفّر مساحة عمل مجهّزة بالكهرباء والإنترنت، مفتوحة مجّاناً للمبدعين والمستقلّين والباحثين عن العلم والعمل في غزّة.",
