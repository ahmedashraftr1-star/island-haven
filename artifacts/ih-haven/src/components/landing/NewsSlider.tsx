                  ...
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      ...
                      <div className="px-3 pb-3 pt-6">
                        ...
                        >
                          {c.ctaCard}
                          <ArrowLeft className="h-3.5 w-3.5 transition-transform duration-[400ms] ease-[cubic-bezier(.2,.7,.2,1)] ltr:rotate-180 rtl:group-hover:-translate-x-1 ltr:group-hover:translate-x-1 rtl:group-hover:translate-x-1 motion-reduce:transition-none" aria-hidden />
                        </Link>
                      </div>
                    </motion.div>
                  </AnimatePresence>
