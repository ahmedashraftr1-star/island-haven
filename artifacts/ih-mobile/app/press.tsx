...
const BOILERPLATE =
  "آيلاند هيفن حاضنة أعمال غزّاويّة. نَحتضن المشاريع الناشئة والمستقلّين والخرّيجين عبر الإرشاد، وبرامج الاحتضان، ومكتبة موارد، وشبكة من الخبراء والشركاء. رؤيتنا: تمكين الشباب واختصار المسافة بينهم وبين سوق العمل العالميّ عبر الاقتصاد الرقميّ — عقولٌ تقهر الركام.";
