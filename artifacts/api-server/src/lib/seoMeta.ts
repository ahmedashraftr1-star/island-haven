...
const ROUTE_META: Record<string, Meta> = {
  ...
  "/membership": {
    title: "مجتمع المواهب",
    description:
      "طلابٌ وخرّيجون ومستقلّون من آيلاند هيفن — مطوّرون ومصمّمون ومحلّلو بيانات من قلب غزّة نحو العالم.",
  },
  "/impact": {
    title: "أثرنا",
    description:
      "أثر آيلاند هيفن بالأرقام الحقيقيّة من قاعدة بياناتنا — مواهب غزّة التي نأخذ بيدها نحو الاقتصاد الرقميّ. أرقامٌ موقّعة يمكنك التحقّق منها.",
  },
  "/hackathon": {
    title: "الهاكاثون",
    description:
      "هاكاثون آيلاند هيفن — تحدٍّ واقعيّ، فرقٌ من مواهب غزّة، إرشادٌ مباشر، ثمّ يوم عرض. من الفكرة إلى الأثر في أيّام.",
  },
  "/press": {
