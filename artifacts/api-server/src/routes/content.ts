...
export const CONTENT_SCHEMA: SectionDef[] = [
  {
    ...
    fields: [
      txt("eyebrow", "الكتابة العلوية", "Island Haven · Gaza · حاضنة أعمال مجّانيّة"),
  ...
  },
  {
    ...
    fields: [
      ...
      long("body", "نص التعريف", "حاضنة أعمال مجّانيّة في غزّة — نوفّر بيئة عمل مجهّزة بالكهرباء والإنترنت، مفتوحة للمبدعين والمستقلّين والباحثين عن العلم والعمل."),
  ...
  },
  {
    ...
    fields: [
      ...
      long("aboutBody", "نص التعريف", "حاضنة أعمال مجّانيّة في غزّة — نوفّر بيئة عمل مجّانيّة للمستقلّين والخرّيجين وطلبة الجامعات، مع برامج تدريب وفرص تشبيك."),
      txt("indexLabel", "تسمية الفهرس", "فهرس"),
      txt("programmeLabel", "تسمية المظلّة", "رسالتنا"),
      txt("programmeTitle", "اسم المظلّة", "آيلاند هيفن"),
      long("programmeBody", "نص المظلّة", "حاضنة أعمال مجّانيّة في غزّة تحتضن روّاد الأعمال والمستقلّين والخرّيجين، وتأخذهم من الفكرة إلى المنتج."),
  ...
  },
  {
    ...
    fields: [
      ...
      long("subtitle", "النص الفرعي", "حاضنة أعمال مجّانيّة تتّسع لأحلامك في غزّة. املأ الطلب وسنتواصل معك على واتساب خلال أيّام."),
      // Section 01 — identity
