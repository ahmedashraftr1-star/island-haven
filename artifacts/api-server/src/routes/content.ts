...
export const CONTENT_SCHEMA: SectionDef[] = [
  {
    ...
    fields: [
      txt("eyebrow", "الكتابة العلوية", "Island Haven · Gaza · حاضنة أعمال"),
      txt("title1", "السطر الأول من العنوان", "مساحةٌ تتّسع لأحلامك،"),
      txt("title2", "السطر الثاني من العنوان (مُلوّن)", "في قلب غزّة."),
      long("subtitle", "النص الفرعي", "بيتٌ مهنيّ يحتضن المستقلّين والخرّيجين وطلبة الجامعات. مكتبٌ، إنترنت، وقهوة — وبكلّ راحة."),
      txt("ctaPrimary", "نص الزر الأساسي", "سجّل للانتساب"),
  ...
  },
  {
    ...
    fields: [
      ...
      long("body", "نص التعريف", "حاضنة أعمال في غزّة — نوفّر بيئة عمل مجهّزة بالكهرباء والإنترنت، مفتوحة للمبدعين والمستقلّين والباحثين عن العلم والعمل."),
