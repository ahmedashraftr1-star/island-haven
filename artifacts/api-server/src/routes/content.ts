...
export const CONTENT_SCHEMA: SectionDef[] = [
  {
    ...
    fields: [
      ...
      img("image1", "صورة الخلفية ١", "/photos/IMG_8357.jpg"),
      img("image2", "صورة الخلفية ٢", "/photos/IMG_8347.jpg"),
      img("image3", "صورة الخلفية ٣", "/photos/IMG_8358.jpg"),
      img("image4", "صورة الخلفية ٤", "/photos/IMG_8341.jpg"),
      img("image5", "صورة الخلفية ٥", "/photos/IMG_8352.jpg"),
      img("image6", "صورة الخلفية ٦", "/photos/IMG_8300.jpg"),
    ],
  },
  {
    key: "about",
    ...
    fields: [
      ...
      img("image", "الصورة الجانبية", "/photos/IMG_8347.jpg"),
  ...
  },
  {
    ...
    fields: [
      ...
      img("seg1Image", "فئة ١ — الصورة", "/photos/IMG_8347.jpg"),
      ...
      img("seg2Image", "فئة ٢ — الصورة", "/photos/IMG_8358.jpg"),
      ...
      img("seg3Image", "فئة ٣ — الصورة", "/photos/IMG_8341.jpg"),
  ...
  },
  {
    ...
    fields: [
      ...
      img("featureImage", "صورة الفعالية الرئيسية", "/photos/IMG_8352.jpg"),
  ...
  },
  {
    ...
    fields: [
      ...
      img("image", "الصورة الجانبية", "/photos/IMG_8358.jpg"),
  ...
  },
  {
    ...
    fields: [
      img("image", "صورة الخلفية", "/photos/IMG_8347.jpg"),
  ...
  },
  {
    ...
    fields: [
      img("image", "صورة الخلفية", "/photos/IMG_8358.jpg"),
  ...
  },
  {
    ...
    fields: [
      ...
      img("image1", "صورة ١", "/photos/IMG_8358.jpg"),
      img("image2", "صورة ٢", "/photos/IMG_8347.jpg"),
      img("image3", "صورة ٣", "/photos/IMG_8344.jpg"),
    ],
  },
  {
    key: "scrollytelling",
    ...
    fields: [
      ...
      img("s1Image", "مشهد ١ — الصورة", "/photos/IMG_8357.jpg"),
      ...
      img("s2Image", "مشهد ٢ — الصورة", "/photos/IMG_8347.jpg"),
      ...
      img("s3Image", "مشهد ٣ — الصورة", "/photos/IMG_8341.jpg"),
      ...
      img("s4Image", "مشهد ٤ — الصورة", "/photos/IMG_8358.jpg"),
      ...
      img("s5Image", "مشهد ٥ — الصورة", "/photos/IMG_8352.jpg"),
      ...
      img("s6Image", "مشهد ٦ — الصورة", "/photos/IMG_8300.jpg"),
    ],
  },
  {
    key: "gallery",
    ...
    fields: [
      ...
      img("p01", "صورة ١", "/photos/IMG_8357.jpg"),
      txt("c01", "تعليق ١", "صباحٌ في المساحة"),
      img("p02", "صورة ٢", "/photos/IMG_8300.jpg"),
      txt("c02", "تعليق ٢", "الجدار الذي يحمل اسمنا"),
      img("p03", "صورة ٣", "/photos/IMG_8347.jpg"),
      txt("c03", "تعليق ٣", "تركيزٌ عميق على التصميم"),
      img("p04", "صورة ٤", "/photos/IMG_8313.jpg"),
      txt("c04", "تعليق ٤", "ركن العمل المشترك"),
      img("p05", "صورة ٥", "/photos/IMG_8352.jpg"),
      txt("c05", "تعليق ٥", "ورشةٌ نتعلّم فيها معاً"),
      img("p06", "صورة ٦", "/photos/IMG_8344.jpg"),
      txt("c06", "تعليق ٦", "زاوية هادئة للتفكير"),
      img("p07", "صورة ٧", "/photos/IMG_8358.jpg"),
      txt("c07", "تعليق ٧", "تشبيكٌ بين الأرواح"),
      img("p08", "صورة ٨", "/photos/IMG_8346.jpg"),
      txt("c08", "تعليق ٨", "جلسة عملٍ مفتوحة"),
      img("p09", "صورة ٩", "/photos/IMG_8341.jpg"),
      txt("c09", "تعليق ٩", "حواراتٌ تُولد منها فرص"),
      img("p10", "صورة ١٠", "/photos/IMG_8345.jpg"),
      txt("c10", "تعليق ١٠", "في انتظار البدء"),
      img("p11", "صورة ١١", "/photos/IMG_8349.jpg"),
      txt("c11", "تعليق ١١", "أيدٍ تبني الغد"),
      img("p12", "صورة ١٢", "/photos/IMG_8353.jpg"),
      txt("c12", "تعليق ١٢", "مساحةٌ تتّسع للتجربة"),
      img("p13", "صورة ١٣", "/photos/IMG_8356.jpg"),
      txt("c13", "تعليق ١٣", "ضحكاتٌ بين الأقران"),
      img("p14", "صورة ١٤", "/photos/IMG_8303.jpg"),
      txt("c14", "تعليق ١٤", "تفاصيل مكاننا"),
      img("p15", "صورة ١٥", "/photos/IMG_8304.jpg"),
      txt("c15", "تعليق ١٥", "أمسيةٌ في الهيفن"),
      img("p16", "صورة ١٦", "/photos/IMG_8307.jpg"),
      txt("c16", "تعليق ١٦", "حضورٌ مهنيّ"),
      img("p17", "صورة ١٧", "/photos/IMG_8308.jpg"),
      txt("c17", "تعليق ١٧", "تركيزٌ جماعيّ"),
      img("p18", "صورة ١٨", "/photos/IMG_8314.jpg"),
