...
async function main() {
  ...
  const TEAM = [
    {
      fullName: "مهنّد جندية", role: "مدير مجتمع آيلاند هيفن", group: "leadership", featured: true,
      bio: "قائد مجتمع آيلاند هيفن في غزّة. يؤمن بتمكين الشباب واختصار المسافة بينهم وبين سوق العمل العالميّ عبر الاقتصاد الرقميّ — عقولٌ تقهر الركام وتبني المستقبل.",
    },
    {
      fullName: "يوسف حلّس", role: "مصمّم جرافيك ومدير محتوى ووسائل تواصل", group: "leadership", featured: true,
      bio: "يقود الهويّة البصريّة والحضور الرقميّ لآيلاند هيفن، ويساعد المشاريع على رواية قصصها بصريًّا.",
    },
    {
